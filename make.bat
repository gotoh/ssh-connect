...
if %COMPILER%==msc     set CMD=cl /nologo connect.c wsock32.lib iphlpapi.lib advapi32.lib
if %COMPILER%==bcc     set CMD=bcc32  connect.c wsock32.lib iphlpapi.lib advapi32.lib
if %COMPILER%==cygwin  set CMD=gcc connect.c -o connect
if %COMPILER%==mingw   set CMD=gcc connect.c -o connect -lwsock32 -liphlpapi
